...
class New_Game_Test():
    def __init__(self, game, white_is_engine = False, black_is_engine = False, white_engine_depth = 2, black_engine_depth = 2, clock_string = '3|2', is_replay = False, replay_moves = None):
        self.game = game
        self.clock = chessclock()
        self.clock.set_chess_clock(clock_string)    # Set the chess clock to the correct setting
        self.moves = [] # Store the moves made in the game so the game may be saved if user requests it
