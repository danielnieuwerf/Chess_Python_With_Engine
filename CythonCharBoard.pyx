...
class CharBoard:
    ...
    def get_diagonals(self, int r, int c):
        # Returns [diag1,diag2] that go through r,c
        cdef int old_r, old_c, min1, min2
    ...
    def get_diagonals_without_empty_squares(self,int r,int c):
    ...
    def get_file_without_empty_squares(self, int c):
        cdef int i
        file = ""
        for i in range(8):
            if self.pieces[i][c]!='.':
    ...
    def get_rank_without_empty_squares(self, int r):
        cdef int i
        rank = ''
        for i in range(8):
            if self.pieces[r][i]!='.':
    ...
    def make_move(self,int i, int j,int x, int y):
    ...
    def pawn_promotion(self,int x, int y):
    ...
    def char_to_value(self, char_to_convert):
        # Given a char returns its value
        if char_to_convert!='.':
            if char_to_convert == 'p':
                return -1
            elif char_to_convert == 'P':
                return 1
            elif char_to_convert == 'n':
                return -3
            elif char_to_convert == 'N':
                return 3
            elif char_to_convert == 'b':
                return -3.15
            elif char_to_convert == 'B':
                return 3.15
            elif char_to_convert == 'r':
                return -5
            elif char_to_convert == 'R':
                return 5
            elif char_to_convert == 'Q':
                return 9
            elif char_to_convert == 'q':
                return -9
    ...
    def create_bitboard_direct_threats_to_king(self, king_colour_is_white):
        ...
        cdef int i, j, up_right, up_left , down_right, down_left
        threats = BitBoard()
