class Scores:
    ...
    material : cython.double
    king_safety : cython.double
    castling_bonus : cython.double
    control_of_centre : cython.double
    control_of_board : cython.double
    bad_knights : cython.double
    threat_by_pawns : cython.double
    isolated_pawns : cython.double
    double_pawns : cython.double
    capturable_unprotected : cython.double
    rook_on_open_file: cython.double
    mobility : cython.double
